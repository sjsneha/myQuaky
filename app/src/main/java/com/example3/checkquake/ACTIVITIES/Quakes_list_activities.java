...
public class Quakes_list_activities extends AppCompatActivity {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    arrayAdapter = new ArrayAdapter<>(Quakes_list_activities.this, android.R.layout.simple_list_item_1,
